...
## 🛠 Skill
<b style="font-size: 1.1em; color: #00A3C4;">[ AI-Development ]</b>
* <mark style="background-color: #E0F7FA; padding: 0 4px;">**Custom AI Agent**</mark> — Automating coding tasks via **Claude Max (Core)** & **Gemini Pro (Assist)**
...
* **Architected a Dual-Model Agent System** (Claude + Gemini) to optimize firmware SDLC.

> **AI-Development**
> * **Custom AI Agent** — Automating coding tasks via **Claude Max** (Core) & **Gemini Pro** (Assist)
...
- Firmware development - ASM
  ...
  <details open>
    ...
    <ul>
      ...
      <li><font color="#15a083">Product Type:</font> <font color="#222222">Amplifier, Mixer, Wireless transceiver, Spectrum analyser, Power conditioner, DB measuring</font></li>
  ...
  <details>
    ...
    <ul>
      ...
      My job responsibilities mainly cover product sales and services, customer relationship maintenance, store operations, and related administrative duties. Specifically, 
          ...
          handling customer complaints, and participating in marketing activities of season.
    </ul>
  </details>   
