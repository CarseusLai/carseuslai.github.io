...
permalink: /
title: ""
excerpt: "Carseus Lai — Principal Engineer. Embedded firmware, audio/vibration signal processing, and AI agent development."
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
<span class="tag">Audio / Acoustic DSP</span>
...
<style>
.tag{display:inline-block;background:#f0e8f6;color:#6C3483;border:1px solid #e0d2ec;border-radius:14px;padding:3px 12px;font-size:.85em;margin:4px 5px 4px 0;font-weight:600;}
/* ---- unify public homepage chrome with the /cv/ page (purple academicpages) ---- */
.masthead{background:#2b1733;border-bottom:1px solid #4a2a63;}
.greedy-nav{background:transparent;}
.greedy-nav a{color:#e8dcf0;font-weight:600;}
.greedy-nav a:hover{color:#ffffff;}
...
.page__content h1,.page__content h2{color:#6C3483;font-weight:700;border-bottom:2px solid #e0d2ec;padding-bottom:6px;margin-top:34px;}
.page__content h1{font-size:1.75em;}
.page__content h2{font-size:1.45em;}
</style>
