...
.agent/
├── ROUTER              ← Weighted intent classifier
├── commands/           ← 15 on-demand commands
├── validators/         ← 5-layer pre-commit pipeline
...
<span style="background-color:#666666; color:#ffffff; border-radius: 20px; padding: 5px 12px; font-weight: 300; font-family: Arial, sans-serif; display: inline-block;">
  ...
  - Embedded Linux - RPB Pi-4B, RedPitaya STEMlab-125-14, PICO-G700A
...
<div class="timeline">
  ...
  <div class="timeline-content">
    ...
    <font color="black">韌體部Firmware Department</font><br>
    <div style="display:flex; margin:10px 0;">
      <div style="display:flex; flex-direction:column; align-items:center; margin-right:12px;">
        ...
        <div style="width:2px; flex:1; background:#999;"></div>
        <div style="width:10px; height:10px; background:#999; border-radius:50%; flex-shrink:0;"></div>
      </div>
