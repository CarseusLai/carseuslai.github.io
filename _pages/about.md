...
# 🎓 Academic
- **Conference Papers**
  - Simulation of Drain Pipe Noise Environment and Practical Noise Reduction with Adaptive Filter NLMS Algorithm(CSSV2024), 模擬排水管噪音環境與實用性降噪之自適應濾波器NLMS演算法(CSSV2024)。
- **Journal Papers**
